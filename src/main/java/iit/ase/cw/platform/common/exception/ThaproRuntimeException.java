...
public class ThaproRuntimeException extends RuntimeException {

    private String messageKey;
    private Object[] parameters = new Object[0];
    private List<ThaproError> errorList = new ArrayList<ThaproError>();

    public ThaproRuntimeException() {
    }

    public ThaproRuntimeException(String messageKey) {
        super(messageKey);
        this.messageKey = messageKey;
    }

    public ThaproRuntimeException(String messageKey, Object... parameters) {
        super(messageKey);
        this.messageKey = messageKey;
        this.parameters = parameters;
    }

    public ThaproRuntimeException(String messageKey, List<ThaproError> errorList,
                                  Object... parameters) {
        super(messageKey);
        this.messageKey = messageKey;
